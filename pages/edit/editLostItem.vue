  ...
  <view class="container">
    <view class="form-container">
      ...
      <view class="form-item">
        ...
        <input class="input" v-model="formData.location" placeholder="请输入丢失地点" />
      </view>
...
export default {
  ...
  methods: {
    ...
    fetchItemDetails() {
      ...
      uni.request({
        url: `${this.baseUrl}/user/lost-items/${this.itemId}/detail`,
        method: 'GET',
        header: {
    ...
    submitForm() {
      ...
      uni.request({
        url: `${this.baseUrl}/user/lost-items/${this.itemId}`,
        method: 'PUT',
        header: {
          'Authorization': 'Bearer ' + uni.getStorageSync('token'),
          'Content-Type': 'application/json'
